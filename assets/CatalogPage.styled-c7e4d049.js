import{l as u,n as X,o as H,r as c,s as t,e as P,j as A,p as q,q as G}from"./index-a9758d23.js";function S(e=u){const o=e===u?X:H(e);return function(){const{store:r}=o();return r}}const N=S();function Y(e=u){const o=e===u?N:S(e);return function(){return o().dispatch}}const D=Y(),uA=e=>e.cars.items,mA=e=>e.cars.page,fA=e=>e.cars.favorite,bA=e=>e.filter.filteredCars,O=e=>c.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,fill:"none",...e},c.createElement("path",{stroke:"#121417",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.8,d:"M18 6 6 18M6 6l12 12"})),Z=t.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
